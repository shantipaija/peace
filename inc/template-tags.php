 ...
 */
	function peace_posted_on() {
		...
		$time_string = '<time class="entry-date published" datetime="%1$s">Published %2$s</time>';
        
		if ( get_the_time( 'U' ) !== get_the_modified_time( 'U' ) ) {
			$time_string .= '  <i class="fa fa-calendar-check-o" aria-hidden="true"></i> <time class="updated" datetime="%3$s">Updated %4$s</time>';
		}
