...
class peace_Categories extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			'classname' => 'peace-cats',
			'description' => esc_html__( 'Peace Categories' ,'peace' ),
		);
		  parent::__construct( 'peace-cats', esc_html__( 'Peace Categories','peace' ), $widget_ops );
	}

	function widget( $args, $instance ) {
		$title = isset( $instance['title'] ) ? $instance['title'] : esc_html__( 'Categories' , 'peace' );
		$enable_count = '';
	...
	function form( $instance ) {
		if ( ! isset( $instance['title'] ) ) {
			$instance['title'] = esc_html__( 'Categories' , 'peace' );
		}
	  ...
	  <p><label for="<?php echo $this->get_field_id( 'limit' ); ?>"> <?php esc_html_e( 'Limit Categories ','peace' ) ?></label>
	  ...
	  <p><label>
		<input  type="checkbox"
		 ...
		 />
			<?php esc_html_e( 'Enable Posts Count','peace' ) ?></label>
	   </p>
