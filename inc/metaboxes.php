...
add_action( 'add_meta_boxes', 'peace_add_custom_box' );
/**
 * Add Meta Boxes.
 *
...
function peace_add_custom_box() {
	...
	add_meta_box('siderbar-layout', //Unique ID
		__( 'Select layout for this specific Post only', 'peace' ), //Title
		'peace_sidebar_layout', //Callback function
	...
	if ( class_exists( 'WooCommerce' ) ) {
		add_meta_box('product-siderbar-layout', //Unique ID
			__( 'Select layout for this specific Product only', 'peace' ), //Title
			'peace_sidebar_layout', //Callback function
...
add_action( 'save_post', 'peace_save_custom_meta' );
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function peace_save_custom_meta( $post_id ) {
	global $site_layout, $post;
