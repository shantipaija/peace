...
function peace_footer_info() {
	...
	printf( esc_html__( 'Theme by %1$s Powered by %2$s', 'peace' ) , '<a href="https://wp.login.plus/" target="_blank">Login.Plus</a>', '<a href="http://wordpress.org/" target="_blank">WordPress</a>' );
}
