jQuery( document ).ready(function() {
    var mediaControl = {
        ...
        select: function() {
            ...
            var selector = jQuery( '.peace-media-container' ).find( mediaControl.selector );
            var data = {
                action: 'peace_get_attachment_media',
                attachment_id: id
            };
            ...
            jQuery.post( peace.ajaxurl, data, function( response ) {
        ...
        init: function() {
            ...
            context.on( 'click', '.peace-media-container .upload-button', function( e ) {
                var container = jQuery( this ).parents( '.peace-media-container' ),
            ...
            context.on( 'click', '.peace-media-container .remove-button', function( e ) {
                var container = jQuery( this ).parents( '.peace-media-container' ),
                    sibling = container.find( 'input' ),
